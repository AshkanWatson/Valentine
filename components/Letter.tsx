...
export function Letter() {
  ...
  const [catImage, setCatImage] = useState("../public/Duck.gif");
  ...
  const handleNoHover = () => {
    ...
    setCatImage("../public/Duck.gif");
    setTimeout(() => {
      setCatImage("../public/Angry_Duck.gif");
    }, 2);
  };

  const handleYesClick = () => {
    setShowFinal(true);
    setCatImage("../public/Dancing_Duck.gif");
  };
  ...
  return (
    <div className={styles.letterContainer}>
      ...
      >
        ...
        <Image
          src={catImage || "../public/placeholder.gif"}
          alt="Cat"
          width={250}
          height={250}
        ...
        {!showFinal && (
          <div className={styles.buttons}>
            <button
              ...
              aria-label="Yes"
            >
              <img src="../public/yes.svg" alt="yes button" width={100} />
            </button>
            ...
            <div className={styles.noWrapper}>
              <button
                ...
                aria-label="No"
              >
                <img src="../public/no.svg" alt="no button" width={100} />
              </button>
            </div>
          </div>
        )}
